...
export const PublishForm = ({ initialData, projectId }: PublishFormProps) => {
            ...
            {!isEditing ? (
                <p className={cn(
                    ...
                    {initialData.isPublished ? (
                        <>This project will be visible by people on the client side</>
                    ) : (
                        <>This project will not be visible by people on the client side</>
                    )}
                </p>
            ) : (
                <Form {...form}>
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        <FormDescription>
                                            Check this box if you want to make this project available on the client side
                                        </FormDescription>
                                    </div>
                                </FormItem>
                            )}
